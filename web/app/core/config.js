 ...
 * @type {string}
 */
let cfg_header_applogo_effect = 'hvr-wobble-top';

/**
 * Efecto cursor sobre ícono index
 * @type {string}
 */
let cfg_header_indexicon_effect = 'hvr-icon-buzz-out';
 ...
 * @type {string}
 */
let cfg_tooltip_theme = 'tooltipster-borderless';

/**
 * Intervalo para ver cambios en la ui (ms)
 * @type {number}
 */
let cfg_ui_watchinterval = 250;
 ...
 * @type {boolean}
 */
let cfg_always_show_err_notification = true;

/**
 * Tiempo de timeout en las notificaciones
 * @type {number}
 */
let cfg_notification_extendedtimeout = 1000;

/**
 * Tiempo para .hide() en las notificaciones
 * @type {number}
 */
let cfg_notification_hideduration = 1000;

/**
 * Tiempo de .show() en las notificaciones
 * @type {number}
 */
let cfg_notification_showduration = 300;

/**
 * Tiempo timeout de las notificaciones
 * @type {number}
 */
let cfg_notification_timeout = 8000;